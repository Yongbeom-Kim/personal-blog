...
Typically, you would either have a kind of central store which maps dotfiles in your git repo to its intended location. Something like `./dotfiles/vim/.vimrc ⭢ $HOME/.vimrc`.
