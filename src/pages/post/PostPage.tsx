  ...
  return (
    <div className="mx-auto pt-10 px-5 pb-20 md:pt-5 md:px-4 md:pb-15">
      ...
      <article>
        ...
        <div className="text-md leading-[1.7] text-text md:text-base [&_h1]:mt-10 [&_h1]:mb-4 [&_h1]:font-bold [&_h1]:text-3xl [&_h1]:text-text [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:font-bold [&_h2]:text-2xl [&_h2]:text-text [&_h3]:mt-10 [&_h3]:mb-4 [&_h3]:font-bold [&_h3]:text-xl [&_h3]:text-text [&_h4]:mt-8 [&_h4]:mb-3 [&_h4]:font-bold [&_h4]:text-lg [&_h4]:text-text [&_p]:mb-6 [&_a]:text-primary [&_a]:underline [&_a]:decoration-1 [&_a]:underline-offset-2 [&_a:hover]:decoration-2 [&_code]:bg-border [&_code]:rounded [&_code]:text-base [&_code]:font-mono [&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-sm [&_blockquote]:border-l-[3px] [&_blockquote]:border-primary [&_blockquote]:pl-5 [&_blockquote]:my-6 [&_blockquote]:italic [&_blockquote]:text-secondary [&_ul]:mb-6 [&_ul]:pl-6 [&_ol]:mb-6 [&_ol]:pl-6 [&_li]:mb-2 md:[&_h1]:text-[28px] md:[&_h2]:text-2xl md:[&_h3]:text-lg md:[&_h4]:text-base">
          {PostComponent && <PostComponent
            components={{ img: (props: { src: string; alt: string; title?: string }) => <Image src={`/assets/${slug}/${props.src}`} alt={props.alt} title={props.title} />, p: P, pre: Pre }}
          />}
        </div>
      </article>
    </div>
