...
When it comes to software, I'm more of a do-it-myself kinda guy. I'm here to write code, not to play dependency lego, you know? For this reason, I'm starting _this_ project with a minimalistic tech stack. I understand that this probably isn't the way most developers would go about self-hosting blogs, but it's just so much more interesting writing everything by yourself.

### The Current Stack

This blog is a simple React/Vite + Typescript project, with Tailwind for styling and MDX for writing posts. It is _not_ SEO-optimized, currently renders content client-side (CSR), and is probably the most bare-bones and unoptimized blog you might find on the internet.
...
I am starting from the most basic stack there is - just an Client-Side SPA React/Vite app, and I hope to slowly add features like SSR (and SEO), MPA, code splitting, etc.
