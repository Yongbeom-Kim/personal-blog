...
title: You are't doing dark theme right...
date: '2025-09-06'
...
```javascript
// ❌ Still causes FOUC despite persistence
...
```javascript
// ✅ Read theme synchronously during initialization
function ThemeProvider({ children }) {
